...
let faveColors = ['blue', 'purple', 'pink']
...
let me = {
    firstName: 'Khai',
    superHeroName: 'Captain Car mel',
    homeTown: 'Tropolis',
    superPowers: ['Hindsight', 'Fortune', 'Visibility'],
...
// CODE HERE
  ...
  let newData = {regularName:firstName, superHeroName:superName, homeTown:homeTown }
